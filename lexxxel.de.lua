...
txt(_a, "v=DMARC1; p=none; rua=mailto:abuse@lexxxel.de; ruf=mailto:abuse@lexxxel.de; sp=none; ri=86400", 180)
...
txt(concat("mail", _a), "v=DMARC1; p=none; rua=mailto:abuse@lexxxel.de; ruf=mailto:abuse@lexxxel.de; sp=none; ri=86400", 180)
