...
mx("mail.lexxel.de", "mail.lexxxel.de", 5)
...
txt("mail.lexxxel.de", "Ko7oBlWssUn6P2i09VF3/Ok4fAjPIfbTL/XIZG9enf+3jOVpmSQRxMuYg6yN6oNbZ6Ytq/zKVhTHvyTj8LiBtRqpjZn50fELdhX4zA93hL22n7+rrwRfNoSQoEARdx5iq1pFAevwIDAQAB", 180)

txt("mail.lexxxel.de", "v=spf1 mx ~all", 180)

txt("mail.lexxxel.de", "v=DMARC1; p=none; rua=mailto:abuse@lexxxel.de; ruf=mailto:abuse@lexxxel.de; sp=none; ri=86400", 180)
